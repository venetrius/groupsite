      ...
      <div style={{ margin: '2rem' }}>
        ...
        {example(
          <div>
            ...
            document, which will be translated into HTML before rendering it to
            the browser. In other words, it lets you refer React Components as
            HTML tags.
            <br />
            ...
            <br />
            One more thing. When a function returns a JSX code snippet it should
            be enclosed into one parent tag.
          </div>,
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                cunstructor. Later on, you can modify a state of a component by
                calling the this.setstate() function. Doing that will (sooner or
                later) result of the rerendering of the component. For more
                check out a &nbsp;
              ...
              <li>
                ...
                implement. It is automatically called when your component gets
                used. It should return the appropriate JSX code.
              </li>
              <li>
